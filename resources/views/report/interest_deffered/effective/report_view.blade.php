            ...
            <section class="section">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title">Report Interest Deferred - Effective</h5>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 row">
                                    <label class="col-sm-3 col-form-label d-flex justify-content-end">Maturity Date</label>
                                    <div class="col-sm-6">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th>Effective Interst Base On Effective Yield</th>
