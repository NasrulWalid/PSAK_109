                        ...
                        <form>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 row d-flex align-items-center mb-1">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text font-size 12px" class="form-control form-control-sm" value="null" readonly style="font-size: 12px;">
                                    </div>
                                </div>
                            </div>
                            <!-- Row 2 -->
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 row d-flex align-items-center mb-1">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text font-size 12px" class="form-control form-control-sm" value="{{ $loan->eircalc_cost }}" readonly style="font-size: 12px;">
                                    </div>
                                </div>
                            </div>
                            <!-- Row 4 -->
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 row d-flex align-items-center mb-1">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text font-size 12px" class="form-control form-control-sm" value="{{ $loan->interest }}" readonly style="font-size: 12px;">
                                    </div>
                                </div>
                            </div>
                        </form>
