...
<div class="card mb-4">
    <div class="card-header">
        <h5 class="card-title">Amortised Initial Cost - Simple Interest</h5>
    </div>
    <div class="card-body">
        <form>
            <!-- Row 1 -->
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6 row">
                    <label class="col-sm-4 col-form-label d-flex justify-content-end">Outstanding Amount Initial Cost</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" value="null" readonly>
                    </div>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6 row">
                    <label class="col-sm-4 col-form-label d-flex justify-content-end">EIR Cost Calculated</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" value="{{ $loan->eircalc_cost }}" readonly>
                    </div>
                </div>
            </div>
            <!-- Row 4 -->
