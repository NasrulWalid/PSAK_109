                        ...
                        <form>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 row d-flex align-items-center mb-1">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text font-size 12px" class="form-control form-control-sm" style="font-size: 12px;" value="{{ $loan->eircalc_conv }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <!-- Row 3 -->
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 row d-flex align-items-center mb-1">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text font-size 12px" class="form-control form-control-sm" style="font-size: 12px;" value="{{ $loan->interest }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </form>
